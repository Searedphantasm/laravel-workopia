    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <a
                ...
                class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300 {{request() -> is('jobs/create') ? 'text-yellow-500 font-bold ' : ''}}"
            >
